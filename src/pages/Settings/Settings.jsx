const Settings = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] bg-v-dark-soft rounded-3xl border border-v-dark-border p-12 text-center">
      ...
      <h2 className="text-3xl font-bold text-v-white mb-4">Configuración</h2>
      <p className="text-v-gray max-w-md">Personalice los parámetros del sistema y gestione permisos de usuario.</p>
    </div>
  );
};
